...
Pixel blend(Pixel oldColor, Pixel newColor) {
  newColor.r = newColor.a / 255.0 * (newColor.r - oldColor.r) + oldColor.r;
  newColor.g = newColor.a / 255.0 * (newColor.g - oldColor.g) + oldColor.g;
  newColor.b = newColor.a / 255.0 * (newColor.b - oldColor.b) + oldColor.b;
  newColor.a = 255;
  return newColor;
}
